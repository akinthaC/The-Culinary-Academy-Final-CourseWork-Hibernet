...
public class javaMailUtil {
    public static boolean sendMail(String recepient ,int otp)  {
        try {
            ...
            String myAccountEmail = "asthennakoon33@gmail.com";
            String password = "ctzyaceccrexgsie";
            ...
            ex.printStackTrace();
            new Alert(Alert.AlertType.ERROR, "Failed to send email. Check Internet connection.").show();
            return false;
        }
